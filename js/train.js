function booking() {
    ...
    if (sourceEl.value === '') {
        sourceError.innerHTML = "source station is required";
    ...
    if (destinationEl.value === '') {
        destinationError.innerHTML = "destination station is required";
    ...
    if (trainnameEl.value === '') {
        trainnameError.innerHTML = "Train Name is required";
    ...
    if (trainnoEl.value === '') {
        trainnoError.innerHTML = "Train No is required";
...
window.location.href="./trainseat.html"
}
